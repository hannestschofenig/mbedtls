...
#if defined(MBEDTLS_SSL_PROTO_TLS1_3) && defined(MBEDTLS_SSL_KEYUPDATE_ENABLE)
#if defined(PSA_WANT_ALG_SHA_384)
#define MBEDTLS_SSL_TLS1_3_APPLICATION_TRAFFIC_KEY_LEN        48
#elif defined(PSA_WANT_ALG_SHA_256)
#define MBEDTLS_SSL_TLS1_3_APPLICATION_TRAFFIC_KEY_LEN        32
#endif
#endif /* MBEDTLS_SSL_PROTO_TLS1_3 && MBEDTLS_SSL_KEYUPDATE_ENABLE */
...
#define MBEDTLS_SSL_MSG_KEY_UPDATE             24
...
typedef enum
{
    ...
    MBEDTLS_SSL_KEY_UPDATE_REQUEST,
	MBEDTLS_SSL_KEY_UPDATE_RESPONSE,
	MBEDTLS_SSL_KEY_UPDATE_SEND,
	MBEDTLS_SSL_KEY_UPDATE_RECEIVE,
	MBEDTLS_SSL_KEY_UPDATE
}
mbedtls_ssl_states;
